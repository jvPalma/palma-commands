...
- **JSON Export**: Added `--export/-exp` flag to export all PR data to JSON files
- **Data Preservation**: Complete PR information exported including checks, reviews, labels, and metadata
- **File Organization**: Exported files organized with clear naming conventions

#### 🔍 Enhanced Review Display
- **Review Requests**: Now displays pending review requests alongside completed reviews
- **Request Status**: Clear indication of who has pending review requests vs completed reviews
- **Review State Tracking**: Comprehensive tracking of review states and requests
